...
Given you have written your problem definition and the customer has signed off on it, it is time to start preparing your data. The aim of this step is to create a base table or multiple tables that feed into your analysis or modelling. Data preparation may be iterative, as the analysis or modelling in the next step becomes refined with frequent feedback from stakeholders.
