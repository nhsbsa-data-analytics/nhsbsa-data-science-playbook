...
- SQL can be used via libraries, such as `{dplyr}` in R
...
- RAP considerations (LINK?)
  - The time to make the preparation easy to repeat is worth it
  - Rather than just doing adhoc testing, create tests that can be repeated
...
- Validation
  ...
  - You can check the results for yourself if the dataset supports it, since you will know if something is wrong
