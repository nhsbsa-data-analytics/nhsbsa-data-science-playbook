...
Given you have access to the data you need, you should start to interrogate it. During this process, you should keep a spreadsheet to document all anomalies, caveats, and quality issues so that you can communicate these to the customer. A good tip is to document for each column:
