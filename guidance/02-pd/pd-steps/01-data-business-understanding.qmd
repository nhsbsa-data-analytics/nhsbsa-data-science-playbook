...
Given you have access to the data you need, you should start to interrogate it.

- use a spreadsheet to document all anomalies, caveats, and quality issues.
- communicate data quality issues with the customer

Good data documentation can include:
...
You can update the limitations section of the Problem Definition (PD). This will inform the customer of what is possible and not possible to achieve during the initiative.

You might find other interesting avenues or datasets to explore that the customer didn't think about. In this case, it is important to discuss your ideas with them and see if they are worth pursuing.
