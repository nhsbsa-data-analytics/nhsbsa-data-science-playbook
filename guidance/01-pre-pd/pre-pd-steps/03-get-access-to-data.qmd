...
- If you don’t have access to the data already, you will need request access.
- To access the data you need for initiatives, email the DALL data holder and team manager. - - They will confirm and provide the data from the DALP Oracle database.
