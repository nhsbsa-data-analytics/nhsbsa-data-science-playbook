...
* SharePoint folder to store documents and data.
* A GitHub repository to store and monitor code.

## Tips for Setting Up the Resources

Before creating resources, you will need to identify the DALL initiative number.

- Guidance on setting these up can be found on the DALL OneNote Wiki.
